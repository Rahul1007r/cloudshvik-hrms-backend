...
const empDashRoutes      = require('./routes/empDashboard.routes');
const employeesRoutes    = require('./routes/employees.routes');
const employeeFormRoutes = require('./routes/employeeForm.routes');
const attendanceRoutes   = require('./routes/attendance.routes');
const attApprovalRoutes  = require('./routes/attendanceApproval.routes'); // ← Module 11
const timesheetRoutes    = require('./routes/timesheet.routes');
const orgRoutes          = require('./routes/orgstructure.routes');
...
app.use('/api/attendance-approval',  attApprovalRoutes); // ← Module 11
